...
namespace NSysmon.Core.SqlServer
{
    public enum AutomatedBackupPreferences : byte
    {
        Primary = 0,
        Secondary = 1,
        [Description("Prefer Secondary")]
        PreferSecondary = 2,
        [Description("Any Replica")]
        AnyReplica = 3
    }

    public enum AvailabilityModes : byte
    {
        [Description("Asyncrhonous Commit")]
        AsyncrhonousCommit = 0,
        [Description("Syncrhonous Commit")]
        SynchronousCommit = 1
    }

    public enum QuorumTypes : byte
    {
        [Description("Node Majority")]
        NodeMajority = 0,
        [Description("Node and Disk Majority")]
        NodeAndDiskMajority = 1,
        [Description("Node and File Share Majority")]
        NodeAndFileShareMajority = 2,
        [Description("No Majority")]
        NoMajority = 3,
        [Description("Unknown")]
        Unknown = 4
    }
    ...
    {
        [Description("Unknown Quorum State")]
        Unknown = 0,
        [Description("Normal")]
        Normal = 1,
        [Description("Forced")]
    ...
    {
        [Description("WSFC Node")]
        WSFCNode = 0,
        [Description("Disk Witness")]
        DiskWitness = 1,
        [Description("File Share Witness")]
        FileShareWitness = 2
    }
    ...
    public enum JoinStates : byte
    {
        ...
        NotJoined = 0,
        [Description("Joined (Standalone)")]
        JoinedStandalone = 1,
        [Description("Joined (Failover)")]
        JoinedFailover = 2
    }
    ...
    public enum SuspendReasons : byte
    {
        ...
        UserAction = 0,
        [Description("Suspend From Partner")]
        ...
        Undo = 6,
        Revaldiation = 7,
        [Description("Error in the calculation of the secondary replica synchronization point")]
        ErrorInSecondaryReplicaSyncPoint = 8
    }

    public enum SynchronizationHealths : byte
    {
        [Description("Not Healthy (None)")]
        NotHealthy = 0,
        [Description("Partially Healthy (Some)")]
        PartiallyHealthy = 1,
        [Description("Healthy")]
        Healthy = 2
    }
    ...
    {
        [Description("2008 & 2008 R2 (70)")]
        Level70 = 70,
        [Description("2008 & 2008 R2 (80)")]
        Level80 = 80,
        [Description("2008 - 2012 (90)")]
        Level90 = 90,
        [Description("2008 - 2012 (100)")]
        Level100 = 100,
        [Description("2012 Only (110)")]
        Level110 = 110
    }
    ...
    {
        None = 0,
        [Description("Torn Page Detection")]
        TornPageDetection = 1,
        Checksum = 2
    }
    ...
    public enum LogReuseWaits : byte
    {
        ...
        LogBackup = 2,
        [Description("active Backup or Restore")]
        ActiveBackupOrRestore = 3,
        ...
        Replication = 6,
        [Description("Database Snapshot Creation")]
        DatabaseSnapshotCreation = 7,
        [Description("Log Scan")]
        LogScan = 8,
        [Description("Always On Replication")]
        AlwaysOnReplicaTransactionLogs = 9,
    ...
    public enum SnapshotIsolationStates : byte
    {
        Off = 0,
        On = 1,
        [Description("On (Transitioning to Off)")]
        TransitioningToOff = 2,
        [Description("Off (Transitioning to On)")]
        TransitioningToOn = 3
    }
    ...
    {
        [Description("Not started, pending communication")]
        NotStarted = 0,
        [Description("Started and running")]
        Running = 1,
        [Description("Not started and failed")]
        Failed = 2
    }
    ...
    public enum ServiceStatuses
    {
        ...
        StartPending = 2,
        [Description("Stop Pending")]
        StopPending = 3,
        Running = 4,
        [Description("Continue Pending")]
        ContinuePending = 5,
        [Description("Pause Pending")]
        PausePending = 6,
        Paused = 7
    }
