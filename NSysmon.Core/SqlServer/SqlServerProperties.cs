...
namespace NSysmon.Core.SqlServer
{
    public class SqlServerProperties
    {
        ...
        public IsClusteredStatus IsClustered { get; private set; }

        public decimal CurrentMemoryPercent
        {
            get
            {
                return CommittedBytes / (decimal)PhysicalMemoryBytes * 100;
            }
        }
        ...
        public string MajorVersion
        {
            get
            {
                ...
                return !string.IsNullOrWhiteSpace(Version) ? "Unknown: " + Version : "Unknown";
            }
        }
...
Select Cast(SERVERPROPERTY(''ProductVersion'') as nvarchar(128)) Version,
       ...
       Cast(SERVERPROPERTY(''ComputerNamePhysicalNetBIOS'') as nvarchar(128)) ComputerNamePhysicalNetBIOS,
